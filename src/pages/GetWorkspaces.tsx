      ...
      <div className="hidden lg:flex flex-1 h-[calc(100vh-13rem)] relative">
        ...
        {mapCollapsed && (
          <button
            ...
            className="fixed top-[196px] right-8 z-30 w-10 h-10 rounded-full border border-border bg-card shadow-md flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-all duration-200 cursor-pointer"
            aria-label="Show map"
          >
