    ...
    <section id="contact" className="py-20 lg:py-28 bg-foreground relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <span className="italic">in the UAE?</span>
        </motion.h2>
        ...
        >
          Get a free consultation with our e-commerce setup specialists. We'll map out your licence, payment gateway, and launch plan.
        </motion.p>
