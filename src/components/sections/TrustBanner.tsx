...
const stats = [
  ...
  { value: "47+", label: "Industries", icon: Briefcase },
  { value: "100+", label: "Spaces", icon: MapPin },
  { value: "98%", label: "Approval Rate", icon: ShieldCheck },
  { value: "<3 Days", label: "Turnaround Time", icon: Star },
];
  ...
  return (
    <section className="py-16 lg:py-20 border-y border-border/40 bg-muted text-primary">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-2 sm:grid-cols-3 <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-4 divide-y sm:divide-y-0 sm:divide-x divide-border"> gap-6 lg:gap-4 divide-y sm:divide-y-0 sm:divide-x divide-border">
          {stats.map((stat) => (
