          ...
          <div className="sticky top-[80px] z-20 bg-[#f5f5f5]">
            <div className="flex flex-col items-center">
              <motion.div
                ...
                transition={{ duration: 0.6, ease: "easeOut" }}
              >
                <span className="block text-5xl sm:text-6xl lg:text-7xl font-medium tracking-[-0.03em] text-foreground leading-[1.08]">
                  Not Just Listings
                </span>
              </motion.div>
    ...
    <section className="relative w-full bg-[#f5f5f5]">
      <div className="relative z-10 w-full flex flex-col items-center px-6">
        <motion.div
          ...
          className="w-full max-w-[1200px] mx-auto pt-8 sm:pt-12 lg:pt-16 pb-16"
        >
