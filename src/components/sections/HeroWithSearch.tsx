        ...
        <div className="max-w-[1100px] w-full">
          ...
          >
            <motion.span
              ...
              className={`block text-5xl sm:text-6xl lg:text-7xl font-medium tracking-[-0.03em] text-white leading-[3] transition-all duration-[400ms] ease-out ${collapsed ? 'hidden' : ''}`}
            >
            ...
            <motion.span
              ...
              className="block text-5xl sm:text-6xl lg:text-7xl font-medium tracking-[-0.03em] text-white leading-[3] transition-all duration-[400ms] ease-out"
            >
              Not Just Listings
            </motion.span>
          </motion.div>
